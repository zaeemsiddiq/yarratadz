...
<form action="#" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="contact col-md-6 fade-down validate" target="_blank" novalidate>
		...
		<footer class="fade-down">
			<p class="footer-text">&copy; yarratadz 2016, All Rights Reserved. Made with love by afrussel</p>
		</footer>
		<!-- Footer end here -->
	</section>
<!-- About start here -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content pop-up pop-up-cnt">
        ...
        if(isset($_POST['submit'])){
        	...
        	$to="office@yarratadz.com"; // Add your e-mail here
        	if($code!=$captcha){
